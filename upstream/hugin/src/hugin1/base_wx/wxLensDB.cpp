...
LoadLensDBDialog::LoadLensDBDialog(wxWindow *parent)
{
    ...
    // get display size
    hugin_utils::RestoreFramePosition(this, "LoadLensDialog", true);
    bool b;
...
void LoadLensDBDialog::OnOk(wxCommandEvent & e)
{
    ...
    hugin_utils::StoreFramePosition(this, "LoadLensDialog", true);
    wxConfigBase * config = wxConfigBase::Get();
...
SaveLensDBDialog::SaveLensDBDialog(wxWindow *parent)
{
    ...
    //set parameters
    wxConfigBase * config = wxConfigBase::Get();
    hugin_utils::RestoreFramePosition(this, "SaveLensDialog", true);
    bool b;
...
void SaveLensDBDialog::OnOk(wxCommandEvent & e)
{
    ...
    //store selected options
    hugin_utils::StoreFramePosition(this, "SaveLensDialog", true);
    wxConfigBase * config = wxConfigBase::Get();
